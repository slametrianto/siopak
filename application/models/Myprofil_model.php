<?php   
    ...
    class Myprofil_model extends CI_Model {
        ...
        function detail($nip){
            ...
            $this->db->join('master_tipefungsional','master_jenjang.id_tipefungsional = master_tipefungsional.id_tipefungsional','left');
        ...
        function update_data($whereid, $data)
        {
