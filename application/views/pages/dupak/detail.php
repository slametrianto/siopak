...
<table class="table table-striped">
    ...
    <tr>
        <td> File SPT </td> <Td> :</Td> <td> <a onclick="preview_data('file_spt/<?php echo $data->file_spt ?>','File SPT')" class="btn btn-primary"> Klik untuk Preview </a> </td>
    </tr>
    <tr>
    ...
    <tr>
        <td> Tanggal Mulai </td> <td> : </td> <td> <?php echo tgl_indo($data->tanggal_mulai) ?> </td>
    </tr>
    <tr>
        <td> Tanggal Selesai </td> <td> : </td> <td> <?php echo tgl_indo($data->tanggal_selesai) ?> </td>
    </tr>
</table>
...
<tr>
    <td> <?php echo $k+1; ?></td>
    <td> <a onclick="preview_data('files/<?php echo $v->file_upload ?>','Bukti Kegiatan')" class="btn btn-primary"> Klik Untuk Detail </a> </td>
    <td> 
