 <?php if($this->session->userdata('is_penguji') != 1 ){
                             redirect('login');
                        // echo "<script>
                ...
                <ul style="margin-right:0;" class="nav navbar-nav navbar-right">
                    <li>
                        ...
                        <ul style="margin-top:14px;" role="menu" class="dropdown-setting dropdown-menu">
                             ...
                             <li><a href="<?php echo base_url('login/logout'); ?>" onClick="return confirm('Apakah anda ingin keluar dari aplikasi ?');"><i class="fa fa-key"></i>&nbsp;&nbsp;Log Out</a></li>
                        </ul>
                    </ul>
