            ...
            <div id="tree-wrap">
                <div class="side-bar">
                    ...
                    <ul class="topnav menu-left-nest">
                        ...
                        <li>
                            <a class="tooltip-tip ajax-load" href="<?php echo base_url() ?>" title="Dashboard">
                            ...
                            <li>
                            <a class="tooltip-tip ajax-load" href="<?php echo base_url() ?>dupak" title="Mail">
                                <i class="icon-mail"></i>
                            <span>Data DUPAK 
                        ...
                        <li>
                            <a class="tooltip-tip ajax-load" href="<?php echo base_url() ?>dupaklama" title="Mail">
                                <i class="icon-mail"></i>
                            <span> DUPAK  Sebelumnya
                                <!-- <div class="noft-blue">289</div> -->
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="tooltip-tip ajax-load" href="<?php echo base_url() ?>biodata" title="Mail">
                                <i class="icon-mail"></i>
