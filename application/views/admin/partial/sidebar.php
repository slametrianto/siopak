            ...
            <div id="tree-wrap">
                <div class="side-bar">
                    ...
                    <ul class="topnav menu-left-nest">
                        ...
                        <li>
                            <a class="tooltip-tip ajax-load" href="<?php echo base_url() ?>backend/dashboard" title="Dashboard">
                         ...
                         <li>
                            <a class="tooltip-tip ajax-load" href="<?php echo base_url() ?>backend/struktural" title="Mail">
                                <i class="icon-mail"></i>
                                <span>Struktural/Fungsional</span>
                        ...
                        <li>
                            <a class="tooltip-tip ajax-load" href="<?php echo base_url() ?>backend/user" title="Mail">
                                <i class="icon-mail"></i>
                        ...
                        <li>
                            <a class="tooltip-tip ajax-load" href="<?php echo base_url() ?>backend/penguji" title="Mail">
                                <i class="icon-mail"></i>
                        ...
                        <li>
                            <a class="tooltip-tip ajax-load" href="<?php echo base_url() ?>backend/pengajuan" title="Mail">
                                <i class="icon-mail"></i>
                                <span>Pengajuan Dupakk  </span>
                                <div class="noft-purple-number">
                                    <?php echo notifmenu("penilaian",array("status" => 1)) ?>
                                </div>
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="tooltip-tip ajax-load" href="<?php echo base_url() ?>backend/paklama" title="Mail">
                                <i class="icon-mail"></i>
                                <span>PAK Sebelumnya  </span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="tooltip-tip " href="<?php echo base_url() ?>backend/login/logout" title="login">
